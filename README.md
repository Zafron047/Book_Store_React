...
Clone this repository to your desired folder:
  ...
  cd my-folder
  git clone https://github.com/Zafron047/Book_Store_React.git
...
Feel free to check the [issues page](https://github.com/Zafron047/Book_Store_React/issues).
